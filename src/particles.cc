...
particleBase::particleBase()
{
    ...
    partBuf.pid = -1; partBuf.mass = -1.0; partBuf.color[0] = -99;partBuf.color[1] = -99; partBuf.q3 = -4; partBuf.p4v = TLorentzVector(0.0,0.0,0.0,0.0);
    ...
    //Put in some more blanks to get to ELE_PID
    partBuf.pid = -1; partBuf.mass = -1.0; partBuf.q3 = -4;
    partLUT.push_back(partBuf); //17
    partLUT.push_back(partBuf); //18
    partLUT.push_back(partBuf); //19
    partLUT.push_back(partBuf); //20
    //21 Gluon
    partBuf.pid = GLU_PID; partBuf.mass = GLU_MASS; partBuf.q3 = GLU_Q3;
    partLUT.push_back(partBuf);
}
